...
import { CalendarDays, ChevronDown, ChevronUp, Loader2, Shield, Trophy, Users } from "lucide-react";
...
type Match = { id: string; roundId: string; homeTeam: { id: string; name: string; slug: string }; awayTeam: { id: string; name: string; slug: string }; scheduledAt: string | null; venue: { id: string; name: string } | null; workflowStatus: string; workflowLabel: string; result: null | { kind: "played" | "special"; summary: string; status: string; statusLabel: string; sets: Array<{ number: number; homeGames: number; awayGames: number }>; actualPlayers: { home: string[]; away: string[] }; specialType?: string } };
...
type TeamResponse = { available: true; found: true; snapshot: { season: Snapshot["season"]; phases: Phase[]; selectedPhase: Phase }; team: { id: string; name: string; slug: string; slogan: string | null; logoUrl: string | null; imageUrl: string | null; roster: Array<{ id: string; displayName: string; isCaptain: boolean }>; standing: Standing | null; nextMatch: TeamMatch | null; schedule: TeamMatch[] } };
